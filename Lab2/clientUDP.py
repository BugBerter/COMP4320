...
def udp_client(args):
    ...
    try:
        for x in range(0, 7):
            ...
            if err_msg == (err_checksum, GID, requestID, 0, 0):
                continue
            ...
            if resp_checksum != resp[2]:
                ...
                for i, host in enumerate(hostnames):
                    print host + ": %d.%d.%d.%d" % (ipaddresses[i*4],ipaddresses[i*4+1],ipaddresses[i*4+2],ipaddresses[i*4+3])
